...
const GoogleAuthModal = () => {
    ...
    const handleEmailSubmit = (e) => {
        ...
        signInWithEmail(email.trim(), name.trim() || 'Verified User');
    };
            ...
            >
                ...
                <div className="space-y-3">
                    <button
                        ...
                        className="w-full py-3.5 px-4 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-200 font-bold rounded-2xl hover:bg-slate-50 dark:hover:bg-slate-800 shadow-sm transition flex items-center justify-center gap-3 text-sm"
                    >
                        {/* Google G Logo SVG */}
                    ...
                    <div className="relative flex py-1 items-center">
                        ...
                        <span className="flex-shrink mx-4 text-[11px] uppercase tracking-wider text-slate-400 font-semibold">Or with Email</span>
                        <div className="flex-grow border-t border-slate-200 dark:border-slate-800"></div>
                    </div>
                    ...
                    <form onSubmit={handleEmailSubmit} className="space-y-3 text-left">
                        <input
                            type="text"
                            placeholder="Your Name (e.g. Master Manikant)"
                            value={name}
                        ...
                        <input
                            type="email"
                            required
                            placeholder="Your Email (e.g. connect@mastermanikant.com)"
                            value={email}
